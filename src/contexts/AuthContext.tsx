...
const ROLE_MODULES: Record<AppRole, string[]> = {
  ...
  tenant_admin: ["sites", "workforce", "funding", "onboarding", "staff_enrollment", "service_approvals", "service_operations", "rostering", "safe_environment", "sil", "restrictive_practices", "governance", "participant_care", "medication", "dashboard", "incidents", "risks", "complaints", "policies", "participants", "staff", "training", "audit", "heartbeat", "safeguarding", "privacy", "settings", "controls", "competency", "evidence_room"],
  super_admin: ["sites", "workforce", "funding", "onboarding", "staff_enrollment", "service_delivery", "service_approvals", "service_operations", "rostering", "safe_environment", "sil", "restrictive_practices", "governance", "participant_care", "medication", "dashboard", "incidents", "risks", "complaints", "policies", "participants", "staff", "training", "audit", "heartbeat", "safeguarding", "privacy", "settings", "controls", "competency", "evidence_room"],

  compliance_officer: ["sites", "workforce", "funding", "staff_enrollment", "service_approvals", "service_operations", "rostering", "safe_environment", "sil", "restrictive_practices", "governance", "participant_care", "medication", "dashboard", "incidents", "risks", "complaints", "policies", "participants", "staff", "training", "audit", "heartbeat", "safeguarding", "privacy", "controls", "competency", "evidence_room"],
  supervisor: ["sites", "workforce", "service_approvals", "service_operations", "rostering", "safe_environment", "sil", "restrictive_practices", "participant_care", "medication", "dashboard", "incidents", "risks", "complaints", "participants", "staff", "training", "safeguarding"],
